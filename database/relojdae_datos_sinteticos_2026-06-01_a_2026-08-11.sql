...
-- ------------------------------------------------------------
WITH personas(codigo_empleado, nombres, apellido_paterno, apellido_materno, correo, zk_user_id, rn) AS (
    VALUES
        ('TEST-1001','Ana','Torres','Molina','ana.torres.test@dae.local','9101',1),
        ('TEST-1002','Carlos','Mendoza','Ruiz','carlos.mendoza.test@dae.local','9102',2),
        ('TEST-1003','Daniela','Ruiz','Vargas','daniela.ruiz.test@dae.local','9103',3),
        ('TEST-1004','Eduardo','Salas','Ortega','eduardo.salas.test@dae.local','9104',4),
        ('TEST-1005','Fernanda','Lopez','Castro','fernanda.lopez.test@dae.local','9105',5),
        ('TEST-1006','Gabriel','Ortega','Navarro','gabriel.ortega.test@dae.local','9106',6),
        ('TEST-1007','Isabel','Castro','Mendez','isabel.castro.test@dae.local','9107',7),
        ('TEST-1008','Jorge','Navarro','Luna','jorge.navarro.test@dae.local','9108',8)
),
base AS (
...
SELECT
    ...
    p.apellido_paterno,
    p.apellido_materno,
    concat_ws(' ',p.nombres,p.apellido_paterno,p.apellido_materno),
    1,
    2,
    NULL,
    DATE '2026-01-01',
